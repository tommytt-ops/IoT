  ...
  "node_modules/chai/lib/chai/core/assertions.js"(exports, module) {
    module.exports = function(chai3, _2) {
      ...
      function assertProperty(name, val, msg) {
        ...
        var isDeep = flag(this, "deep"), negate = flag(this, "negate"), pathInfo = isNested ? _2.getPathInfo(obj, name) : null, value = isNested ? pathInfo.value : obj[name], isEql = isDeep ? flag(this, "eql") : (val1, val2) => val1 === val2;
        ;
        var descriptor = "";
        if (isDeep)
          descriptor += "deep ";
...
function createTestContext(test3, runner2) {
  ...
  return ((_a8 = runner2.extendTaskContext) == null ? void 0 : _a8.call(runner2, context)) || context;
}
...
function splitByComma(s2) {
  ...
  for (let i2 = 0; i2 < s2.length; i2++) {
    if (s2[i2] === "{" || s2[i2] === "[") {
      stack.push(s2[i2] === "{" ? "}" : "]");
    } else if (s2[i2] === stack[stack.length - 1]) {
      stack.pop();
    } else if (!stack.length && s2[i2] === ",") {
      const token = s2.substring(start, i2).trim();
      if (token)
        result.push(token);
      start = i2 + 1;
    }
...
var c2 = Symbol.for("tinyspy:spy");
var g = /* @__PURE__ */ new Set();
var C2 = (e) => {
  e.called = false, e.callCount = 0, e.calls = [], e.results = [], e.next = [];
};
var M2 = (e) => (f(e, c2, { value: { reset: () => C2(e[c2]) } }), e[c2]);
var A2 = (e) => e[c2] || M2(e);
function I2(e) {
  R2(u2("function", e) || u2("undefined", e), "cannot spy on a non-function value");
  let t2 = function(...s2) {
    let r2 = A2(t2);
    r2.called = true, r2.callCount++, r2.calls.push(s2);
    let m2 = r2.next.shift();
    if (m2) {
      r2.results.push(m2);
      let [l2, o] = m2;
      if (l2 === "ok")
    ...
    if (r2.impl)
      try {
        new.target ? p2 = Reflect.construct(r2.impl, s2, new.target) : p2 = r2.impl.apply(this, s2), d2 = "ok";
      } catch (l2) {
        throw p2 = l2, d2 = "error", r2.results.push([d2, l2]), l2;
      }
    let a2 = [d2, p2];
    if (b2(p2)) {
      let l2 = p2.then((o) => a2[1] = o).catch((o) => {
        throw a2[0] = "error", a2[1] = o, o;
      });
      Object.assign(l2, p2), p2 = l2;
    }
    return r2.results.push(a2), p2;
  };
  i(t2, "_isMockFunction", true), i(t2, "length", e ? e.length : 0), i(t2, "name", e && e.name || "spy");
  let n2 = A2(t2);
...
function E2(e, t2, n2) {
  R2(!u2("undefined", e), "spyOn could not find an object to spy upon"), R2(u2("object", e) || u2("function", e), "cannot spyOn on a primitive value");
  let [s2, r2] = (() => {
    if (!u2("object", t2))
      return [t2, "value"];
  ...
  })(), m2 = k(e, s2), p2 = Object.getPrototypeOf(e), d2 = p2 && k(p2, s2), a2 = m2 || d2;
  R2(a2 || s2 in e, `${String(s2)} does not exist`);
  let l2 = false;
  r2 === "value" && a2 && !a2.value && a2.get && (r2 = "get", l2 = true, n2 = a2.get());
  let o;
  a2 ? o = a2[r2] : r2 !== "value" ? o = () => e[s2] : o = e[s2], n2 || (n2 = o);
  let y2 = I2(n2);
  r2 === "value" && P2(y2, o);
  let O2 = (h2) => {
    let { value: G2, ...w2 } = a2 || {
    ...
    r2 !== "value" && delete w2.writable, w2[r2] = h2, f(e, s2, w2);
  }, K2 = () => a2 ? f(e, s2, a2) : O2(o), T2 = y2[c2];
  return i(T2, "restore", K2), i(T2, "getOriginal", () => l2 ? o() : o), i(T2, "willCall", (h2) => (T2.impl = h2, y2)), O2(l2 ? () => (P2(y2, n2), y2) : y2), g.add(y2), y2;
}
...
function getMatcherUtils() {
  const c3 = () => getColors();
  const EXPECTED_COLOR = c3().green;
  const RECEIVED_COLOR = c3().red;
  const INVERTED_COLOR = c3().inverse;
  const BOLD_WEIGHT = c3().bold;
  const DIM_COLOR = c3().dim;
...
function eq(a2, b3, aStack, bStack, customTesters, hasKey2) {
  ...
  for (let i2 = 0; i2 < customTesters.length; i2++) {
    const customTesterResult = customTesters[i2].call(testerContext, a2, b3, customTesters);
...
${spy.mock.calls.map((callArg, i2) => {
        let methodCall = c3().bold(`  ${ordinalOf(i2 + 1)} ${spy.getMockName()} call:
...
Number of calls: ${c3().bold(spy.mock.calls.length)}
`);
    return msg;
  };
...
${spy.mock.results.map((callReturn, i2) => {
      let methodCall = c3().bold(`  ${ordinalOf(i2 + 1)} ${spy.getMockName()} call return:
...
function JestExtendPlugin(expect2, matchers) {
  return (c3, utils) => {
    Object.entries(matchers).forEach(([expectAssertionName, expectAssertion]) => {
      ...
      utils.addMethod(c3.Assertion.prototype, expectAssertionName, softWrapper);
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-AITHXR72.js")).default;
...
function replaceInlineSnap(code, s2, index, newSnap) {
...
var SnapshotClient = class {
  ...
  assert(options) {
    ...
    if (typeof properties === "object") {
      ...
      try {
        const pass2 = ((_b5 = (_a8 = this.options).isEqual) == null ? void 0 : _b5.call(_a8, received, properties)) ?? false;
        if (!pass2)
...
var MockDate = class _MockDate extends RealDate {
  constructor(y2, m2, d2, h2, M3, s2, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s2 = s2 || 0;
        ms = ms || 0;
        date = new RealDate(y2, m2, d2, h2, M3, s2, ms);
        break;
    }
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b5 = (_a8 = this._userConfig) == null ? void 0 : _a8.toFake) == null ? void 0 : _b5.includes("nextTick")) && isChildProcess())
...
function createVitest() {
  ...
  const utils = {
    useFakeTimers(config2) {
      var _a8, _b5, _c, _d;
      if (isChildProcess()) {
        if (((_a8 = config2 == null ? void 0 : config2.toFake) == null ? void 0 : _a8.includes("nextTick")) || ((_d = (_c = (_b5 = workerState.config) == null ? void 0 : _b5.fakeTimers) == null ? void 0 : _c.toFake) == null ? void 0 : _d.includes("nextTick"))) {
          throw new Error(
